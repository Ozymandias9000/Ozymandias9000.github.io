<!-- By Rich Harris - https://github.com/sveltejs/branding, MIT, https://commons.wikimedia.org/w/index.php?curid=85042822 -->
<svg viewBox="0 0 128 128" height="24" width="24" class="inline"><style type="text/css">
    .st0 {
      fill: #ff3e00;
    }
    .st1 {
